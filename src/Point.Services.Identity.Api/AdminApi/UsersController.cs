using Point.Services.Identity.Web.DTOs.Users;
...
where TRoleClaimDto : RoleClaimDto<TKey>
{
    ...
    public async Task<ActionResult<TUserDto>> Post([FromBody] TUserDto user)
    {
        ...
        var (_, userId) = await _identityService.CreateUserAsync(user);
    ...
    {
        bool IsDeleteForbidden(TKey id)
        {
